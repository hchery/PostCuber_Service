...
import cuber.post.app.auth.service.token.RefreshTokenService;
 ...
 */
public class IssueRefreshTokenLoginHandler implements LoginHandler {
    ...
    public LoginToken handle(LoginToken loginToken, LoginHandlerChain chain) {
        ...
        StringToken refreshToken = refreshTokenService.issue(userId);
